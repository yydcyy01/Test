...
<script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"课程管理",
							"menus":[
									{"menuid":"31","menuname":"基础数据(课程)","icon":"icon-user-teacher","url":"CourseServlet?method=toCourseListView"},									
// 									<c:if test="${userType == 1 || userType == 3}">
									{"menuid":"32","menuname":"选课","icon":"icon-user-teacher","url":"ScoreServlet?method=limitScoreList"},
// 									</c:if>
								]
						},
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"3","icon":"","menuname":"成绩管理",
							
							"menus":[
										{"menuid":"42","menuname":"统计管理","icon":"icon-house","url":"ScoreServlet?method=toScoreListView"}
									]
						},
						</c:if>
						<c:if test="${userType == 1 || userType == 3}">
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div region="north" split="true" border="false"
		...
		<span style="float: right; padding-right: 20px;" class="head"><span
			...
			style="padding-left: 10px; font-size: 16px;">教务处管理系统 V1.0</span>
	</div>
	<div region="south" split="true"
		style="height: 30px; background: #D2E0F2;">
		<div class="footer">Copyright &copy; By YYDCYY</div>
	</div>
